<?php
$this->setSiteTitle('New Doctor Account');
...
<div class="container">
    ...
    <form action="<?=SROOT?>doctor/createpost" method="post">
        <fieldset  class="scheduler-border">
            <legend  class="scheduler-border">New a doctor account</legend>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="dob" value='' placeholder="Specialization" name="specialization">
            </div>
            <div class="form-group">
